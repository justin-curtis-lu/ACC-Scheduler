...
SECRET_KEY = 'django-insecure-fq$j=d(9qb+r4pj_c#+tt4h&u$$p(@97ql-9ggt43umto240k4'
...
# API KEYS
load_dotenv()
MONKEY_AUTH = os.getenv('GALAXY_AUTH')  # Survey Monkey
SURVEY_AUTH = os.getenv('MONKEY_AUTH')  # Galaxy Digital
